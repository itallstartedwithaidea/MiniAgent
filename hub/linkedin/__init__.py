"""linkedin Ads hub connector. Translates linkedin API into normalized schema."""

class linkedinConnector:
    """Connector for linkedin advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("linkedin connector: coming in v0.3.0")
