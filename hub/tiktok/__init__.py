"""tiktok Ads hub connector. Translates tiktok API into normalized schema."""

class tiktokConnector:
    """Connector for tiktok advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("tiktok connector: coming in v0.3.0")
