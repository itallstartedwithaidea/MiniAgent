"""meta Ads hub connector. Translates meta API into normalized schema."""

class metaConnector:
    """Connector for meta advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("meta connector: coming in v0.3.0")
