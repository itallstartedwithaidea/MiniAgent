"""tradedesk Ads hub connector. Translates tradedesk API into normalized schema."""

class tradedeskConnector:
    """Connector for tradedesk advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("tradedesk connector: coming in v0.3.0")
