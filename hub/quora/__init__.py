"""quora Ads hub connector. Translates quora API into normalized schema."""

class quoraConnector:
    """Connector for quora advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("quora connector: coming in v0.3.0")
