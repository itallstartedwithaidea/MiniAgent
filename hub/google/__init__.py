"""google Ads hub connector. Translates google API into normalized schema."""

class googleConnector:
    """Connector for google advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("google connector: coming in v0.3.0")
