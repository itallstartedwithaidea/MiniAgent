"""twitter Ads hub connector. Translates twitter API into normalized schema."""

class twitterConnector:
    """Connector for twitter advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("twitter connector: coming in v0.3.0")
