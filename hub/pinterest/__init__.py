"""pinterest Ads hub connector. Translates pinterest API into normalized schema."""

class pinterestConnector:
    """Connector for pinterest advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("pinterest connector: coming in v0.3.0")
