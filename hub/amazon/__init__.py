"""amazon Ads hub connector. Translates amazon API into normalized schema."""

class amazonConnector:
    """Connector for amazon advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("amazon connector: coming in v0.3.0")
