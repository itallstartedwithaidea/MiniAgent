"""snapchat Ads hub connector. Translates snapchat API into normalized schema."""

class snapchatConnector:
    """Connector for snapchat advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("snapchat connector: coming in v0.3.0")
