"""criteo Ads hub connector. Translates criteo API into normalized schema."""

class criteoConnector:
    """Connector for criteo advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("criteo connector: coming in v0.3.0")
