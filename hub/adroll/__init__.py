"""adroll Ads hub connector. Translates adroll API into normalized schema."""

class adrollConnector:
    """Connector for adroll advertising platform."""
    ...
    async def list_campaigns(self) -> list:
        ...
        raise NotImplementedError("adroll connector: coming in v0.3.0")
